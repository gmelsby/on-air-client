...
export default function HomePage({lightState, updateState, isConnected}:
  ...
  <>
    ...
    <div className="flex flex-col justify-around align-middle">
      <div className={`text-center${lightState === 'offline' || !isConnected ? '' :' pt-36'}`}>
      ...
      {isConnected && lightState !== 'offline' &&
        <div className='flex flex-col md:flex-row justify-center'>
          {lightState !== 'off' &&
            <button className="btn bg-gray-600 m-2 text-stroke text-xl
          ...
          {lightState !== 'on-air' &&
            <button className="btn bg-red-600 m-2 text-stroke text-xl
          ...
          {lightState !== 'on-camera' &&
            <button className="btn bg-blue-600 m-2 text-stroke text-xl
